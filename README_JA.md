...
4. `npm install -g @qq849693559/iflow-cli` を実行してiFlow CLIをインストールしてください
...
7. `npm install -g @qq849693559/iflow-cli` を実行してiFlow CLIをインストールしてください
...
GitHub ActionsのワークフローでもiFlow CLIをコミュニティがメンテナンスするアクションで使用できます: [iflow-cli-action](https://github.com/qq849693559/iflow-cli-action)
