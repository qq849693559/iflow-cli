...
4. Выполните `npm install -g @qq849693559/iflow-cli` для установки iFlow CLI
...
7. Выполните `npm install -g @qq849693559/iflow-cli` для установки iFlow CLI
...
Вы также можете использовать iFlow CLI в ваших рабочих процессах GitHub Actions с помощью действия, поддерживаемого сообществом: [iflow-cli-action](https://github.com/qq849693559/iflow-cli-action)
